...
class ProfileElementControllerTest extends BaseTestCase
{
    ...
    public function testAnonDelete() {
        $client = $this->makeClient();
        $crawler = $client->request('GET', '/profile_element/1/delete');
        $this->assertEquals(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect('http://localhost/login'));
    }
    ...
    public function testAdminDelete() {
        $preCount = count($this->em->getRepository(ProfileElement::class)->findAll());
        $client = $this->makeClient(LoadUser::ADMIN);
        $crawler = $client->request('GET', '/profile_element/1/delete');
        $this->assertEquals(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect());
        ...
        $this->em->clear();
        $postCount = count($this->em->getRepository(ProfileElement::class)->findAll());
